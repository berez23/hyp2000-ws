...
class Hyp2000ControllerTest extends TestCase
{
    ...
    public function test_hyp2000_json() 
    {
        ...
        $IngvControllerTest_class = new IngvControllerTest();              
        $hyp2000OutputJsonExpected__json__structure = $IngvControllerTest_class->getArrayStructure(json_decode($response->content(), true));        
